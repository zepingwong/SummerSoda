<template>
  <div>
    <ul class="icon_lists dib-box">
      ...
      <li class="dib">
        <span class="icon iconfont icon-menu-arrow"></span>
        <div class="name">
          menu-arrow
        </div>
      ...
      <li class="dib">
        <span class="icon iconfont icon-docs"></span>
        <div class="name">
          docs
        </div>
        <div class="code-name">.icon-docs
        </div>
      </li>

      <li class="dib">
        <span class="icon iconfont icon-FAQ"></span>
        <div class="name">
          FAQ
        </div>
        <div class="code-name">.icon-FAQ
        </div>
      </li>
      ...
      <li class="dib">
        <span class="icon iconfont icon-suggestion"></span>
        <div class="name">
          suggestion
        </div>
        <div class="code-name">.icon-suggestion
        </div>
      </li>
      ...
      <li class="dib">
        <span class="icon iconfont icon-tools"></span>
        <div class="name">
          tools
        </div>
        <div class="code-name">.icon-tools
        </div>
      </li>

      <li class="dib">
        <span class="icon iconfont icon-SD"></span>
        <div class="name">
          SD
        </div>
        <div class="code-name">.icon-SD
        </div>
      </li>
